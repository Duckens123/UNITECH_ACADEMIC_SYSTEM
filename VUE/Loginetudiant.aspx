<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Loginetudiant.aspx.cs" Inherits="UNITECH_ACADEMEIC_SYSTEME.VUE.Loginetudiant" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Connection etudiant</title>
    ...
    <div class="row d-flex justify-content-center align-items-center h-100">
      ...
      <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1 mt-3">
          ...
          <div class="form-outline mb-4">
              <asp:TextBox ID="tpinstudent" runat="server"  placeholder="Entrer un PIN valide" class="form-control form-control-lg"></asp:TextBox>
            <label class="form-label" for="form3Example3">PIN</label>
          </div>

          <!-- Password input -->
          <div class="form-outline mb-3">
              <asp:TextBox ID="tpassstudent" runat="server" TextMode="Password" MaxLength="5" placeholder="Entrer mot de passe" class="form-control form-control-lg"></asp:TextBox>
